...
module Geo
  ...
  class RepositoryBaseSsfSyncService
    ...
    attr_reader :replicator, :repository, :registry
    ...
    def fetch_snapshot_into_temp_repo
      ...
      return if pool_repository_available? && replicator.model_record.pool_repository
    ...
    def mark_sync_as_successful(missing_on_primary: false)
      ...
      persisted = registry.synced!(missing_on_primary: missing_on_primary)
    ...
    # At the moment repository pools available for project repositories only
    def pool_repository_available?
      false
    end
